...
// Раздаём всё из папки public (images, css, js и т.д.)
...
app.listen(port, () => {
    ...
    console.log(`   http://localhost:${port}/glamp-detail.html - детали домика`);
    console.log(`\n API эндпоинты:`);
    console.log(`   GET  /api/glamps - список домиков`);
    console.log(`   GET  /api/services - список услуг`);
    console.log(`   GET  /api/reviews - отзывы`);
    console.log(`   POST /api/bookings - бронирование`);
    console.log(`   POST /api/service-orders - заказ услуг`);
